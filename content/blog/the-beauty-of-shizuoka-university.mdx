...
<a href={"https://drive.google.com/file/d/1cw6-CBh1De-tv10E6BRbT3XguqzRi2CB/view?usp=share_link"} target={"_blank"}><img src={"/assets/uniApplication/cover.jpg"} alt={"eBook"} width={"500px"} height={"500px"} className={"mx-auto"}/></a>
