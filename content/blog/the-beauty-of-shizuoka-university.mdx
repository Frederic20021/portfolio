...
Shizuoka University has a tutoring system where new students are paired with Japanese senior students who provide guidance on most aspects of their life in Japan. For example, residential registration at the city office, opening a bank account and filling out Japanese application forms. Thus, with the tutor system, international students are provided with support that will ensure a smooth transition to their student life in Japan.

<p className={"text-center"}>__________________________________</p>

# A pre-release Guidebook on "Study Abroad in Japan"

<a href={"https://drive.google.com/file/d/1YqmgD2j741l3VDhEJXxYHd5FTn2UB0sd/view?usp=share_link"} target={"_blank"}><img src={"/assets/uniApplication/cover.jpg"} alt={"eBook"} width={"500px"} height={"500px"} className={"mx-auto"}/></a>
