...
```
=SUMIF(CreditCardMay[Type],"*usage*",CreditCardMay[Credit])
```
...
This example is just a basic level of using excel formula to keep your tracking efficient. And there are a lot of more ways that you can use to customized to your own circumstances.
