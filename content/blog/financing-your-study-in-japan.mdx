...
The custom formula that I used focuses on dividing the **Credit** value of the each **Table** based on their [**Type**] (either "food" or "usage").
...
The resources on how to use advance excel spread sheets are available online and it is highly recommended to check them out for more efficient way of keeping track of your expenses.
...
- Look for internships or be an research assistance as they are more likely to align with your studies and you also get paid for it.

- Use any type of spread sheet to keep track of your spending! (_Remember, "What you can measure, You can improve" .... - **Alex Hormozi**_)
