...
So as I sat down on the chair at the start of the interview, I still don't know why but there was just silence and a pause that lasted for more than five seconds.
...
<img src={"/assets/internship/demo.jpg"} alt={"Data Scraping"} className={"mx-auto"}/>
<p className={"text-center"}>Fig: The Concept of WebScrapping with UiPath</p>
...
Of course, I cannot say for sure for all other companies in Japan, and it was during the time when Covid-19 restrictions started to ease, but I could see that working in Japan is not like how the internet portrays where employees are being overworked.
...
Nearing in to the end of the internship, we were required to prepare and deliver a presentation on what we learned and implemented throughout the internship.
...
After the internship was over, the program still required me to produce a report and make another presentation on the tasks during the internship that were relevant to my course of study.
This is the final task of the internship program at my university. And this time, I made sure to not include any live demonstration but pre-recorded performance of the tasks as I did not want to risk having errors in front of the professor in charge.
With the deliverance of the presentation, the entire process of the internship was finally over and I got the credit registered.
