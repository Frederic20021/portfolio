  ...
  return (
    <div className="font-sans mt-[100px] text-gray-800">
      ...
      <section
        ...
        className="relative text-white py-[300px] sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] flex items-center bg-cover bg-center"
      >
