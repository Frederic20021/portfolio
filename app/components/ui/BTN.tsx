...
export default function BTN ({ text, href } : params) {
    return (
        <>
            <Link href={href}
                className="py-2 px-4 hover:px-8 m-4 text-center mx-auto border duration-500 border-blue-400 rounded-4xl flex items-center gap-8 hover:gap-14 text-black group ">
