...
const BlogCard = async () => {
    ...
    return (
        <div className="flex flex-col snap-y hover:snap-mandatory overflow-y-scroll max-h-[800px] gap-6 sm:max-md:max-w-[400px] md:max-lg:max-w-[500px] lg:max-w-[600px]">
